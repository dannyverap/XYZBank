...
public class CustomerDelegateImplTest {
    ...
    public void testGetCustomerDetails() {
        ...
        ResponseEntity<CustomerResponse> response = customerDelegate.findCustomerById(UUID.randomUUID());
    ...
    public void testUpdateCustomer() {
        given(customerService.updateCustomer(any(UUID.class), any(CustomerRequest.class))).willReturn(customerResponse);

        ResponseEntity<CustomerResponse> response = customerDelegate.updateCustomer(UUID.randomUUID(), customerRequest);
