...
public class CustomerServiceImplTest {
    ...
    public void testDeleteCustomerWithActiveAccounts() {
        ...
        given(accountClient.getAccountsByClientId(customer.getId())).willReturn(List.of(createAccountResponse(100.0)));
    ...
    public void testDeleteCustomerWithZeroBalanceAccounts() {
        given(customerRepository.existsById(customer.getId())).willReturn(true);
        given(accountClient.getAccountsByClientId(customer.getId())).willReturn(List.of(createAccountResponse(0.0)));
