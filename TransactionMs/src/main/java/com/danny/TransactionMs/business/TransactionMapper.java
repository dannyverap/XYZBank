...
public class TransactionMapper {
    public Transaction getTransactionFromRequest(TransactionRequest transactionRequest) {
        ...
        transaction.setFecha(Date.from(transactionRequest.getFecha().atStartOfDay(ZoneId.systemDefault()).toInstant()));
    ...
    public TransactionResponse getTransactionResponseFromTransaction(Transaction transaction) {
        ...
        transactionResponse.setFecha(transaction.getFecha().toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
